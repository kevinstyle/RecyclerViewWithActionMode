package com.ccz.viewimages.dragselect;
...
import com.ccz.viewimages.custom.DragSelectAdapterHelper;
...
public abstract class DragSelectRecyclerViewAdapter<VH extends RecyclerView.ViewHolder> extends RecyclerView.Adapter<VH> {
    ...
    // Kevin, use for android action mode
    private Context                 mContext;
    private DragSelectAdapterHelper mHelper;

    protected DragSelectRecyclerViewAdapter(Context context) {
        mSelectedIndices = new ArrayList<>();
        mContext = context;
    }

    // Kevin
    public void setDragSelectHelper(DragSelectAdapterHelper helper) {
        mHelper = helper;
    }
    ...
    public DragSelectAdapterHelper getDragSelectHelper() {
        return mHelper;
    }
    //////////////////////////////////////////////////////////////////////////
    ...
    public final void selectRange(int from, int to, int min, int max) {
        ...
        Log.e("selectRange", "from = " + from);
        Log.e("selectRange", "to = " + to);
        Log.e("selectRange", "min = " + min);
        Log.e("selectRange", "max = " + max);
