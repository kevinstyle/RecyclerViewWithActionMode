...
public class DragSelectRecyclerView extends RecyclerView {
    ...
    // Kevin
    private boolean mDragSelectActiveAlways;
    ...
    // Kevin
    public void setDragSelectActive(boolean active) {
        mDragSelectActive = active;
    }
    public void setDragSelectActiveAlways(boolean active) {
        mDragSelectActive = active;
        mDragSelectActiveAlways = active;
    }
    ////////////////////////////////////////////////////////
        ...
        if (mDragSelectActive) {
            ...
            if (e.getAction() == MotionEvent.ACTION_UP) {
                ...
                if (itemPosition != -2 && mLastDraggedIndex != itemPosition) {
                    Log.e("selectRange", "mLastDraggedIndex = " + mLastDraggedIndex);
                    Log.e("selectRange", "itemPosition = " + itemPosition);
