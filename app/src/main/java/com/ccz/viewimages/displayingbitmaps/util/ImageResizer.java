...
public class ImageResizer extends ImageWorker {
    ...
    /**
     * The main_option_menu processing method. This happens in a background task. In this case we are just
...
//        Bitmap bmap = null;
//        try{
//            Log.e("aaaaaaa","options= " + options.toString() +" " + options.inBitmap);
//            bmap = BitmapFactory.decodeFileDescriptor(fileDescriptor, null, options);
//            return bmap;
...
//        return null;
    ...
    public static int calculateInSampleSize(BitmapFactory.Options options, int reqWidth, int reqHeight) {
        ...
        if (height > reqHeight || width > reqWidth) {
            ...
            long totalPixels = width * height / (4 * inSampleSize * inSampleSize);
