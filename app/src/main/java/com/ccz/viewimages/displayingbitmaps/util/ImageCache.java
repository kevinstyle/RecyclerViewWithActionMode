...
public class ImageCache {
    ...
    private static final int DEFAULT_MEM_CACHE_SIZE = 1024 * 10; // ori 5mb

    // Default disk cache size in bytes
    private static final int DEFAULT_DISK_CACHE_SIZE = 1024 * 1024 * 20; // ori 10mb

    // Compression settings when writing images to disk cache
    private static final CompressFormat DEFAULT_COMPRESS_FORMAT = CompressFormat.JPEG;
    private static final int DEFAULT_COMPRESS_QUALITY = 60; //70
     ...
     * executed on the main_option_menu/UI thread. By default an ImageCache does not initialize the disk
     ...
     * this includes disk access so this should not be executed on the main_option_menu/UI thread.
     */
     ...
     * disk access so this should not be executed on the main_option_menu/UI thread.
     */
    public void flush() {
        synchronized (mDiskCacheLock) {
            if (mDiskLruCache != null) {
    ...
    public static int getBitmapSize(BitmapDrawable value) {
        ...
        if (FlavorUtils.hasHoneycombMR1()) {
