 ...
 *
 * <p>CustomAsyncTask is designed to be a helper class around {@link Thread} and {@link Handler}
...
public abstract class CustomAsyncTask<Params, Progress, Result> {
     ...
     */
    public static final Executor SERIAL_EXECUTOR = FlavorUtils.hasHoneycomb() ? new SerialExecutor() :
            Executors.newSingleThreadExecutor(sThreadFactory);

    public static final Executor DUAL_THREAD_EXECUTOR =
            Executors.newFixedThreadPool(2, sThreadFactory);

    public static final Executor DUAL_THREAD_EXECUTOR_CHANNEL2 =
            Executors.newFixedThreadPool(2, sThreadFactory);
...
//                            e.getCause());
                    Log.e("CustomAsyncTask", "An error occured while executing doInBackground()");
     ...
     * CustomAsyncTask, however you can also use your own {@link Executor} for custom
     * behavior.
     *
