...
//            final String dataString = (mData instanceof MediaItem) ? ((MediaItem) mData).getCacheKey() : String.valueOf(mData); //bling bling
            ...
            if (mData instanceof MediaItem) {
                ...
                if (item.getSource().equals(MediaItem.SOURCE_SHARE) || item.getSource().equals(MediaItem.SOURCE_AUSTOR)) {
...
//                return true;
            } else if (imageView.getVisibility() != View.VISIBLE && THUMB_MODE_WBUFFER_STEP2 == mDoubleThumbingLevel) {
        ...
        if (mFadeInBitmap) {
            ...
            if (null != transbitmap) {
                imageView.setBackgroundDrawable(
                        new BitmapDrawable(mResources, transbitmap));
            }
